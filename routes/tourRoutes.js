...
router
  .route('/tour-stats')
  .get(authController.protected, tourController.getTourStats);
router
  .route('/monthly-plan/:year')
  .get(authController.protected, tourController.getMontlyPlan);
router
  .route('/')
...
router
  ...
  .delete(
    ...
    authController.userRole('admin', 'lead-guide'),
